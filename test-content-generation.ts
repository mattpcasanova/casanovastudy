...
const TEST_CONFIGS = [
  {
    ...
    additionalInstructions: 'Focus ONLY on the provided content about water solubility. Generate 12-15 flashcards covering the key concepts mentioned in the source material. Use helpful analogies and examples to clarify the provided concepts.'
  },
  {
    ...
    topicFocus: 'Water Solubility',
    difficultyLevel: 'intermediate',
    additionalInstructions: 'Create questions ONLY about the concepts explicitly mentioned in the provided content. Include multiple choice, true/false, and short answer questions. Use clear examples and analogies in questions to test understanding of the provided concepts.'
  },
  {
    ...
    topicFocus: 'Water Solubility',
    difficultyLevel: 'intermediate',
    additionalInstructions: 'Organize ONLY the provided content into a clear hierarchical outline with essential, important, and supporting sections. Use helpful analogies and examples to clarify the provided concepts.'
  },
  {
    ...
    topicFocus: 'Water Solubility',
    difficultyLevel: 'intermediate',
    additionalInstructions: 'Summarize ONLY the provided content, focusing on the key relationships and concepts mentioned in the source material. Use helpful analogies and examples to make the concepts more understandable.'
  }
];
...
export { testContentGeneration, SAMPLE_MARINE_SCIENCE_CONTENT, TEST_CONFIGS };
